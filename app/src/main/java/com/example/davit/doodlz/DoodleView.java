...
public class DoodleView extends View {
    ...
    private Bitmap bitmap; // Область рисования
    private Canvas bitmapCanvas; // Для рисования на bitmap
    private final Paint paintScreen; // Для вывода bitmap
    private final Paint paintLine; // Для рисования линий в bitmap
    ...
    public boolean onTouchEvent(MotionEvent event) {
        int action = event.getActionMasked(); // Тип события(нажал, отпустил, etc...)
